...
var IGNORE_ELEMENTS = ["SCRIPT", "STYLE", "LINK", "NOSCRIPT", "IFRAME", "OBJECT", "EMBED", "PARAM", "SOURCE", "CANVAS", "SVG", "USE", "TRACK", "INPUT", "TEXTAREA", "SELECT", "OPTION", "OPTGROUP", "BUTTON", "LABEL", "FIELDSET", "LEGEND", "BR", "HR", "META", "HEAD"];
...
var INLINE_ELEMENTS = ["SPAN", "A", "STRONG", "B", "I", "EM", "MARK", "PARAM", "SOURCE", "CANVAS", "TRACK", "INPUT", "TEXTAREA", "SELECT", "OPTION", "BUTTON", "LABEL", "FIELDSET", "LEGEND"];
    ...
    function traverseAndUpdate(element, parent, node) {
      for (var i = 0; i < element.children.length; i++) {
        ...
        if (node.nodeType == "TEXT_NODE" || node.nodeType == "INLINE_ELEMENT" || node.nodeType == "BLOCK_ELEMENT"){
            var content = {
                nid: childElement.getAttribute('naitik-id'),
                text: cleanText(childElement.textContent)
            }
